...
public class ProductPatchTest extends TestBaseProduct {
    @Test
    public void updatePriceOfSingleProduct() {
        ...
        productPojo.setPrice(999.99); //price change
        productPojo.setShipping(10);
        productPojo.setUpc("012333424000");
        productPojo.setDescription("2021 Apple iMac 21.5 All-in-One");
